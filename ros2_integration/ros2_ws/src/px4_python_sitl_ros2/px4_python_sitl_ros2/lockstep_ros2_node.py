...
class Px4LockstepRos2Node(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("gps_origin_lat", 48.35386539065191)
        self.declare_parameter("gps_origin_lon", 11.78159133408772)
        self.declare_parameter("gps_origin_alt", 447.0)
