...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("gps_origin_lat", default_value="47.397742"),
            DeclareLaunchArgument("gps_origin_lon", default_value="8.545594"),
            DeclareLaunchArgument("gps_origin_alt", default_value="470.0"),
